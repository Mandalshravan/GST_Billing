      ...
      <div class="container-fluid">
        <div class="row">
         ...
         <div class="card card-info">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form class="form-horizontal" action="{{ url('admin/gst_bills/add') }}" method="post">
                @csrf
                <div class="card-body">
                  ...
                  <div class="form-group row">
                   ...
                   <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                        <input type="number" name="total_amount" class="form-control"  placeholder="Total Amount" required>
                    </div>
                  </div>
                    ...
                    <div class="col-sm-8">
                        <input type="number" name="cgst_rate" class="form-control"  placeholder="CGST Rate" required>
                    </div>
                  </div>
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                        <input type="number" name="sgst_rate" class="form-control"  placeholder="SGST Rate" required>
                    </div>
                  </div>
                   ...
                   <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                        <input type="number" name="igst_rate" class="form-control"  placeholder="IGST Rate" required>
                    </div>
                  </div>
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                        <input type="number" name="cgst_amount" class="form-control"  placeholder="CGST Amount" required>
                    </div>
                  </div>
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                        <input type="number" name="sgst_amount" class="form-control"  placeholder="SGST Amount" required>
                    </div>
                  </div>
                    ...
                    <div class="col-sm-8">
                        <input type="number" name="igst_amount" class="form-control"  placeholder="IGST Amount" required>
                    </div>
                  </div>
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                        <input type="number" name="tax_amount" class="form-control"  placeholder="Tax Amount" required>
                    </div>
                  </div>
                   ...
                   <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                        <input type="number" name="net_amount" class="form-control"  placeholder="Net Amount" required>
                    </div>
                  </div>
                   ...
                   <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                        <textarea name ="declaration" class="form-control" placeholder="Declaration" required></textarea>
                    </div>
                  </div>
