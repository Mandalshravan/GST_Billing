      ...
      <div class="container-fluid">
        <div class="row">
         ...
         <div class="card card-info">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form class="form-horizontal" action="{{ url('admin/parties/edit/'.$getRecord->id) }}" method="post">
                @csrf
                <div class="card-body">
                ...
                <div class="form-group row">
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                      <input type="text" value="{{ $getRecord->full_name }}" name="full_name" class="form-control"  placeholder="Full Name" required>
                    </div>
                  </div>
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                      <input type="text" value="{{ $getRecord->phone_no }}" name="phone_no" class="form-control"  placeholder="Phone no." required>
                    </div>
                  </div>
                   ...
                   <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                      <input type="text" value="{{ $getRecord->address }}" name="address" class="form-control"  placeholder="Address" required>
                    </div>
                  </div>
                   ...
                   <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                      <input type="text" value="{{ $getRecord->account_holder_name }}" name="account_holder_name" class="form-control"  placeholder="Account Holder Name" required>
                    </div>
                  </div>
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                      <input type="text" value="{{ $getRecord->account_no }}" name="account_no" class="form-control"  placeholder="Account No." required>
                    </div>
                  </div>
                   ...
                   <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                      <input type="text" value="{{ $getRecord->bank_name }}" name="bank_name" class="form-control"  placeholder="Bank Name" required>
                    </div>
                  </div>
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                      <input type="text" value="{{ $getRecord->ifsc_code }}" name="ifsc_code" class="form-control"  placeholder="IFSC Code" required>
                    </div>
                  </div>
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                      <input type="text" value="{{ $getRecord->branch_address }}" name="branch_address" class="form-control"  placeholder="Branch Address" required>
                    </div>
                  </div>
